...
V 0.5 Auto tagging for new posts, small modifications here and there..
Author: PsMan
Version: 0.5
...
EOST;
    ...
    echo "<Form method ='post' action='$serv'><textarea name='xx' cols='50' rows='10'>$oldtags</textarea><input type='submit' value='submit'> <br /> <input type='checkbox' name='cst' $chkd />Case Sensetive? </form>";
